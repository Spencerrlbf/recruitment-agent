-- Canonical Layer A PK/FK and trigger checks.
...
with expected_constraints(constraint_name, table_name, constraint_type, referenced_table, delete_rule) as (
    values
        ('candidate_profiles_v2_pkey', 'candidate_profiles_v2', 'PRIMARY KEY', null, null),
        ('candidate_profiles_v2_current_company_id_fkey', 'candidate_profiles_v2', 'FOREIGN KEY', 'companies_v2', null),
        ('candidate_emails_v2_pkey', 'candidate_emails_v2', 'PRIMARY KEY', null, null),
        ('candidate_emails_v2_candidate_id_fkey', 'candidate_emails_v2', 'FOREIGN KEY', 'candidate_profiles_v2', 'CASCADE'),
        ('companies_v2_pkey', 'companies_v2', 'PRIMARY KEY', null, null),
        ('candidate_experiences_v2_pkey', 'candidate_experiences_v2', 'PRIMARY KEY', null, null),
        ('candidate_experiences_v2_candidate_id_fkey', 'candidate_experiences_v2', 'FOREIGN KEY', 'candidate_profiles_v2', 'CASCADE'),
        ('candidate_experiences_v2_company_id_fkey', 'candidate_experiences_v2', 'FOREIGN KEY', 'companies_v2', 'SET NULL')
),
...
with expected_triggers(trigger_name, table_name) as (
    values
        ('set_candidate_profiles_v2_updated_at', 'candidate_profiles_v2'),
        ('set_candidate_emails_v2_updated_at', 'candidate_emails_v2'),
        ('set_companies_v2_updated_at', 'companies_v2'),
        ('set_candidate_experiences_v2_updated_at', 'candidate_experiences_v2')
)
select
